...
const projects = [
  ...
  {
    title: 'Cleano — Plateforme Produits de Nettoyage',
    description: 'Plateforme web destinée aux utilisateurs et distributeurs de produits de nettoyage. Présentation du catalogue, gestion de la distribution et suivi des commandes.',
    technologies: ['React', 'Node.js', 'MongoDB'],
    image: 'cleano.png',
    github: 'https://github.com/RihabJenzeri',
    demo: 'https://cleano-tn.com/',
    color: '#ec4899',
    period: '2026',
    company: 'Cleano — Freelance',
    stats: { stars: 12, contributors: 1, commits: 64 },
  },
  // {
